...
namespace VoxelRender
{
    ...
    TArray<FVoxelChunkRenderPayload>& Batch)
	{
	    ...
	    for (const FVoxelChunkRenderPayload& P : Batch)
	    {
	    	...
	    	{
	    		RD->InitFromPooled(nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, EChunkNormalFormat::None, 0, 0, P.ChunkOriginWS, P.ChunkSize);
	    	}
	    	else
	    	{
	    		RD->InitFromPooled(G.VertexPooled, G.NormalsPooled, G.IndexPooled, G.TangentBasisPooled, G.VertexColorPooled, G.VertexUV0Pooled, G.VertexMaterialIdPooled, Format, VCount, ICount, P.ChunkOriginWS, P.ChunkSize);
	    	}
